...
var BreadcrumbDelimiter = function BreadcrumbDelimiter(_ref) {
    ...
    return delimiter === DELIMITER_CARET ? React.createElement(IconChevron, { className: 'be-breadcrumb-seperator', color: COLOR_999, direction: 'right', size: '7px' }) : React.createElement(
        'span',
        null,
        '/'
    );

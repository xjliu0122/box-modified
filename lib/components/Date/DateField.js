...
var DEFAULT_DATE_FORMAT = { weekday: 'short', month: 'short', year: 'numeric', day: 'numeric' };

var DateField = function DateField(_ref) {
    var date = _ref.date,
        _ref$dateFormat = _ref.dateFormat,
        dateFormat = _ref$dateFormat === undefined ? DEFAULT_DATE_FORMAT : _ref$dateFormat,
        _ref$omitCommas = _ref.omitCommas,
        omitCommas = _ref$omitCommas === undefined ? false : _ref$omitCommas,
        intl = _ref.intl,
        _ref$relative = _ref.relative,
        relative = _ref$relative === undefined ? true : _ref$relative,
